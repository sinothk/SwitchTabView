 ...
 * <pre>
 */
public class ScrollTitleTab extends HorizontalScrollView implements View.OnClickListener, ViewPager.OnPageChangeListener {
    /**
     * TAB类型
     */
    ...
    public ScrollTitleTab(Context context) {
        this(context, null);
    }

    public ScrollTitleTab(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollTitleTab(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
     ...
     * 设置titles
     */
    public ScrollTitleTab setTitles(List<String> ts) {// 3
     ...
     * 设置titles
     */
    public ScrollTitleTab setTitles(List<String> ts, int position) {// 3
        if (this.items != null && ts != null) {
            this.items.clear();
            for (String t : ts) {
                this.items.add(new TabItem(t, ""));
    ...
    public ScrollTitleTab setViewPager(ViewPager viewPager) {
